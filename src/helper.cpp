...
int main() {
    ...
    //create_clangd_settings(".", true, {"XPP", "ABC", "696969"}, 17, true, true);
    ...
    chain_cmds({
        default_command("cat", {}, "",               pipe_from_file("stdin.txt")),
        default_command("cat"),
        default_command("cat", {}, "", pipe_stdin(), pipe_to_file("stdout.txt"))
    });
